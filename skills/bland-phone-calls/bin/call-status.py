#!/usr/bin/env python3
"""Fetch a Bland.ai call's details, including transcript and summary.

Usage:
    call-status.py <call_id>

Prints the provider's JSON response.
"""
...
def main() -> int:
    if len(sys.argv) != 2:
        print("usage: call-status.py <call_id>", file=sys.stderr)
        return 2
    call_id = sys.argv[1]
